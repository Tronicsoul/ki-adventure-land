...
const HeroSection = () => {
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 py-20">
      ...
      <div className="absolute right-0 bottom-0 lg:right-[10%] lg:bottom-[5%] pointer-events-none opacity-30 lg:opacity-50">
        <img src={dinoWaving} alt="" className="w-[300px] md:w-[400px] lg:w-[500px]" />
      </div>
            ...
            delay: 0.7
              ...
              <div className="flex items-center gap-2">
                <div className="flex -space-x-2">
                  {[pastelColors[0], pastelColors[1], pastelColors[2]].map((color, i) => <div key={i} className="w-8 h-8 rounded-full border-2 border-background flex items-center justify-center text-xs font-bold" style={{
                ...
                <span className="text-sm text-muted-foreground">
                  <strong className="text-foreground">XY</strong> Unternehmen vertrauen uns
                </span>
              </div>
            </motion.div>
          </motion.div>
